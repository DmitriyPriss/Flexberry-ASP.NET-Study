...
<%@ Page Language="C#" MasterPageFile="~/Site1.Master"  AutoEventWireup="true" CodeBehind="DisciplinaE.aspx.cs" Inherits="IIS.Product_38416.ДисциплинаE" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="<%= Constants.FormCssClass %> <%= Constants.EditFormCssClass %>">
        <h2 class="<%= Constants.FormHeaderCssClass %> <%= Constants.EditFormHeaderCssClass %>">Дисциплина</h2>
...
<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlКоличествоСиместровИзученияLabel" runat="server" Text="Количество симестров изучения" EnableViewState="False">
</asp:Label>
<ac:AlphaNumericTextBox CssClass="descTxt" ID="ctrlКоличествоСиместровИзучения" Type="Numeric" runat="server">
