...
<%@ Page Language="C#" MasterPageFile="~/Site1.Master"  AutoEventWireup="true" CodeBehind="StudentE.aspx.cs" Inherits="IIS.Product_38416.СтудентE" %>
...
<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlГруппаLabel" runat="server" Text="Группа" EnableViewState="False">
</asp:Label>
<ac:MasterEditorAjaxLookUp ID="ctrlГруппа" CssClass="descTxt" runat="server" ShowInThickBox="True" Autocomplete="true" />

<asp:RequiredFieldValidator ID="ctrlГруппаValidator" runat="server" ControlToValidate="ctrlГруппа"
ErrorMessage="Не указано: Группа" EnableClientScript="true" ValidationGroup="savedoc">*</asp:RequiredFieldValidator>

</div>
<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlГруппа_НазваниеLabel" runat="server" Text="Название" EnableViewState="False">
</asp:Label>
<asp:TextBox CssClass="descTxt" ID="ctrlГруппа_Название" runat="server" ReadOnly="true">
</asp:TextBox>
