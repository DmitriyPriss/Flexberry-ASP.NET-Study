...
namespace IIS.Склад_DPriss
{
    ...
    [View("ЗаказL", new string[] {
            ...
            "ДатаЗаполнения as \'Дата заполнения\'",
            "Менеджер.Фамилия as \'Фамилия\'"})]
    public class Заказ : IIS.Склад_DPriss.Документ
    {
        
        private IIS.Склад_DPriss.СостояниеЗаказа fСтатус;
        
        private System.DateTime fДатаОтгрузки;
        
        private System.DateTime fДатаОплаты;
        
        private IIS.Склад_DPriss.Сотрудник fМенеджер;
        
        private IIS.Склад_DPriss.DetailArrayOfСтрокаЗаказа fСтрокаЗаказа;
        ...
        public virtual IIS.Склад_DPriss.СостояниеЗаказа Статус
        {
            get
            {
                ...
                IIS.Склад_DPriss.СостояниеЗаказа result = this.fСтатус;
        ...
        [PropertyStorage(new string[] {
                "Менеджер"})]
        [NotNull()]
        public virtual IIS.Склад_DPriss.Сотрудник Менеджер
        {
            get
            {
                ...
                IIS.Склад_DPriss.Сотрудник result = this.fМенеджер;
        ...
        public virtual IIS.Склад_DPriss.DetailArrayOfСтрокаЗаказа СтрокаЗаказа
        {
            get
            {
                ...
                {
                    this.fСтрокаЗаказа = new IIS.Склад_DPriss.DetailArrayOfСтрокаЗаказа(this);
                }
                IIS.Склад_DPriss.DetailArrayOfСтрокаЗаказа result = this.fСтрокаЗаказа;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЗаказE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаказE", typeof(IIS.Склад_DPriss.Заказ));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЗаказL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаказL", typeof(IIS.Склад_DPriss.Заказ));
                }
            }
        }
    }
