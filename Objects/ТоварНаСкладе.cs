...
namespace IIS.Склад_DPriss
{
    ...
    public class ТоварНаСкладе : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Склад_DPriss.Склад fСклад;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Склад_DPriss.Склад.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "Склад"})]
        public virtual IIS.Склад_DPriss.Склад Склад
        {
            get
            {
                ...
                IIS.Склад_DPriss.Склад result = this.fСклад;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТоварНаСкладеE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТоварНаСкладеE", typeof(IIS.Склад_DPriss.ТоварНаСкладе));
                }
            }
        }
    }
    ...
    public class DetailArrayOfТоварНаСкладе : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Склад_DPriss.DetailArrayOfТоварНаСкладе members)

        // *** End programmer edit section *** (IIS.Склад_DPriss.DetailArrayOfТоварНаСкладе members)
        ...
        /// </summary>
        public DetailArrayOfТоварНаСкладе(IIS.Склад_DPriss.Склад fСклад) : 
                base(typeof(ТоварНаСкладе), ((ICSSoft.STORMNET.DataObject)(fСклад)))
        {
        }
        
        public IIS.Склад_DPriss.ТоварНаСкладе this[int index]
        {
            get
            {
                return ((IIS.Склад_DPriss.ТоварНаСкладе)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Склад_DPriss.ТоварНаСкладе dataobject)
        {
