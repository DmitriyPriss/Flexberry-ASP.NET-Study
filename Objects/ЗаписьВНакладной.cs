...
namespace IIS.Склад_DPriss
{
    ...
    public class ЗаписьВНакладной : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Склад_DPriss.Товар fТовар;
        
        private IIS.Склад_DPriss.Накладная fНакладная;
        ...
        [PropertyStorage(new string[] {
                "Товар"})]
        [NotNull()]
        public virtual IIS.Склад_DPriss.Товар Товар
        {
            get
            {
                ...
                IIS.Склад_DPriss.Товар result = this.fТовар;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Склад_DPriss.Накладная.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "Накладная"})]
        public virtual IIS.Склад_DPriss.Накладная Накладная
        {
            get
            {
                ...
                IIS.Склад_DPriss.Накладная result = this.fНакладная;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЗаписьВНакладнойE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаписьВНакладнойE", typeof(IIS.Склад_DPriss.ЗаписьВНакладной));
                }
            }
        }
    }
    ...
    public class DetailArrayOfЗаписьВНакладной : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Склад_DPriss.DetailArrayOfЗаписьВНакладной members)

        // *** End programmer edit section *** (IIS.Склад_DPriss.DetailArrayOfЗаписьВНакладной members)
        ...
        /// </summary>
        public DetailArrayOfЗаписьВНакладной(IIS.Склад_DPriss.Накладная fНакладная) : 
                base(typeof(ЗаписьВНакладной), ((ICSSoft.STORMNET.DataObject)(fНакладная)))
        {
        }
        
        public IIS.Склад_DPriss.ЗаписьВНакладной this[int index]
        {
            get
            {
                return ((IIS.Склад_DPriss.ЗаписьВНакладной)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Склад_DPriss.ЗаписьВНакладной dataobject)
        {
