...
namespace IIS.Склад_DPriss
{
    ...
    [View("НакладнаяL", new string[] {
            ...
            "Заказ.Статус as \'Статус\'",
            "МатериальноОтветственноеЛицо.Фамилия as \'Фамилия\'"})]
    public class Накладная : IIS.Склад_DPriss.Документ
    {
        
        private IIS.Склад_DPriss.СостояниеНакладной fСтатус;
        ...
        private IIS.Склад_DPriss.Заказ fЗаказ;
        
        private IIS.Склад_DPriss.Сотрудник fМатериальноОтветственноеЛицо;
        
        private IIS.Склад_DPriss.DetailArrayOfЗаписьВНакладной fЗаписьВНакладной;
        ...
        public virtual IIS.Склад_DPriss.СостояниеНакладной Статус
        {
            get
            {
                ...
                IIS.Склад_DPriss.СостояниеНакладной result = this.fСтатус;
        ...
        [PropertyStorage(new string[] {
                "Заказ"})]
        [NotNull()]
        public virtual IIS.Склад_DPriss.Заказ Заказ
        {
            get
            {
                ...
                IIS.Склад_DPriss.Заказ result = this.fЗаказ;
        ...
        [NotNull()]
        public virtual IIS.Склад_DPriss.Сотрудник МатериальноОтветственноеЛицо
        {
            get
            {
                ...
                IIS.Склад_DPriss.Сотрудник result = this.fМатериальноОтветственноеЛицо;
        ...
        public virtual IIS.Склад_DPriss.DetailArrayOfЗаписьВНакладной ЗаписьВНакладной
        {
            get
            {
                ...
                {
                    this.fЗаписьВНакладной = new IIS.Склад_DPriss.DetailArrayOfЗаписьВНакладной(this);
                }
                IIS.Склад_DPriss.DetailArrayOfЗаписьВНакладной result = this.fЗаписьВНакладной;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View НакладнаяE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("НакладнаяE", typeof(IIS.Склад_DPriss.Накладная));
                }
            }
            ...
            public static ICSSoft.STORMNET.View НакладнаяL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("НакладнаяL", typeof(IIS.Склад_DPriss.Накладная));
                }
            }
        }
    }
