...
namespace IIS.Склад_DPriss
{
    ...
    public class Склад : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Склад_DPriss.Сотрудник fКладовщик;
        
        private IIS.Склад_DPriss.DetailArrayOfТоварНаСкладе fТоварНаСкладе;
        ...
        [PropertyStorage(new string[] {
                "Кладовщик"})]
        [NotNull()]
        public virtual IIS.Склад_DPriss.Сотрудник Кладовщик
        {
            get
            {
                ...
                IIS.Склад_DPriss.Сотрудник result = this.fКладовщик;
        ...
        public virtual IIS.Склад_DPriss.DetailArrayOfТоварНаСкладе ТоварНаСкладе
        {
            get
            {
                ...
                {
                    this.fТоварНаСкладе = new IIS.Склад_DPriss.DetailArrayOfТоварНаСкладе(this);
                }
                IIS.Склад_DPriss.DetailArrayOfТоварНаСкладе result = this.fТоварНаСкладе;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СкладE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СкладE", typeof(IIS.Склад_DPriss.Склад));
                }
            }
            ...
            public static ICSSoft.STORMNET.View СкладL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СкладL", typeof(IIS.Склад_DPriss.Склад));
                }
            }
        }
    }
